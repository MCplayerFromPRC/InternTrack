...
export const SimpleGraph: React.FC<
  PropsWithChildren<{
    ...
    upDateViewData: CallableFunction;
  }>
> = ({
  warningList,
  graphRef,
  ...
  upDateViewData
    ...
    const showNodeMenus = (
      ...
      setNodeMenuPanelPosition({
        x: $event.clientX - 20,
        y: nodeObject?.data?.hasEvalResult ? $event.clientY - (_base_position?.y || 0) - 20 : $event.clientY - (_base_position?.y || 0) + 20,
      });
    };
      ...
      >
        ...
        {isShowNodeMenuPanel && (
          ...
          >
            ...
            {
              currentNode?.data?.hasEvalResult && <div className="c-node-menu-item" onClick={() => doAction("result")}>
                评测结果
              </div>
            }
            ...
            {
              currentNode?.data?.hasEvalResult && <div className="c-node-menu-item" onClick={() => doAction("delete")}>
                删除评测结果
              </div>
            }
          </div>
